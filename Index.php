...
?>
    <section class="py-5 text-center container"
        style="background-image: url('https://twinfinite.net/wp-content/uploads/2023/03/image-2023-03-05T102347.856-1.jpg?fit=1200%2C675');height: 700px; width: 500vh" >
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="detail.php?id=<?= $row['Id'] ?>" class="btn btn-success">More Details</a> <!-- Add button More Details -->
